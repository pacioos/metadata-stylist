...
doctype to make everything work properly in IE:
  ...
  .wrapline {
    ...
    <body onLoad="loadGoogleMap( [ {$bbox} ] )" onUnload="GUnload()"><xsl:value-of select="$newline"/>
    ...
    <table width="185" cellspacing="0" cellpadding="0" style="position: absolute; top: 10px; right: 10px; z-index: 2; background-color: #fff; padding-left: 10px;">
      ...
      <tr>
        <td>
          <p class="callouthead"><a href="http://pacioos.org/metadata/{$datasetIdentifier}.txt?format=fgdc">FGDC Text-Only</a></p>
          <p class="callouttext">Federal Geographic Data Committee (FGDC) in plain text</p>
          <p class="callouthead"><a href="http://pacioos.org/metadata/{$datasetIdentifier}.xml?format=fgdc">FGDC XML</a></p>
          <p class="callouttext">Federal Geographic Data Committee (FGDC) in Extensible Markup Language (XML)</p>
          <p class="callouthead"><a href="http://pacioos.org/metadata/{$datasetIdentifier}.html">ISO HTML</a></p>
          <p class="callouttext">International Organization for Standardization (ISO) 19115:2003 Geographic Information Metadata</p>
        </td>
      </tr>
    </table>
